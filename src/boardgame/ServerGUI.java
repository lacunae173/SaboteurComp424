...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    protected static final String[] PLAYER_CLASSES = { "Saboteur.StudentPlayer","Saboteur.RandomSaboteurPlayer", "student_player.NearlyRandomSaboteurPlayer", "student_player.MontePlayer", "student_player.MinimaxPlayer"}; // "alpha_beta.AlphaBetaPlayer" //"Saboteur.StudentPlayer"
